...
for day in range(1, days_in_month + 1):
    ...
    for n_time_slot in range(len(time_slots) + 1):
        if calendar.day_name[calendar.weekday(next_month.year, next_month.month, day)] in {"Friday", "Saturday", "Sunday"} or date in holidays.US(years=next_month.year): #weekday >= 5
...
thin_side = opyxl.styles.Side(border_style="thin", color="000000")  # Linea sottile, colore nero
